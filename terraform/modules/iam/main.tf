...
# Budget Handler Lambda Role
resource "aws_iam_role" "budget_handler" {
...
resource "aws_iam_role_policy" "budget_handler" {
  name = "budget-handler-policy"
  role = aws_iam_role.budget_handler.id
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "arn:aws:lambda:*:*:function:${var.project_name}-${var.environment}-cost-optimizer"
      },
      {
        Effect = "Allow"
        Action = [
